...
app.controller('signupController', function($scope, postgresqlFactory){
  ...
  $scope.create_login  = function(){
    ...
    var targetNode = document.getElementById('annuaire');
    ...
    lien = "http://annuaire.sso.infra.ftgroup/persons?searchType=PERSON_COMPLEX&personCriteria.cru=&personCriteria.alphabetical=false&personCriteria.sn=guitton&personCriteria.snSelect=STARTSWITH&personCriteria.givenName=alois&personCriteria.givenNameSelect=STARTSWITH&_personCriteria.usePhonetic=on&personCriteria.telephoneNumber=&personCriteria.mail=alois.guitton%40orange.com&personCriteria.ftadmou=&personCriteria.ftsubactivitiescode=&personCriteria.ftactivitiescode=&personCriteria.ftskill=&personCriteria.ftactivities=&personCriteria.siteCriteria.ville=&personCriteria.siteCriteria.site=&personCriteria.siteCriteria.codePostDep=*";
